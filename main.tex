...
\begin{figure}[ht]
\subfloat[]{\includegraphics[width = 3.2in]{topologically-impossible-ellipse}}
\subfloat[]{\includegraphics[width = 3.2in]{topologically-impossible-circle}} 
...
\begin{figure}[ht]
\subfloat[]{\includegraphics[width = 3.2in]{buildings-graph-inside}}
\subfloat[]{\includegraphics[width = 3.2in]{buildings-graph-outside}} 
