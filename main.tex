...
\begin{theorem}[Thurston\text{'}s coin-graph theorem]
...
\begin{figure}[ht]
\centering
\subfloat[The $d=3$ region and its 8 surrounding regions \label{fig:sub:depth-center}]{\includegraphics[width=0.45\textwidth]{depth-map-center}}
